...
**전체 케이스** 3090 · **전체 pass율** 70.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **298** | 648 | 25 | 13 | - |
| qa_fallback (42) | **22** | 15 | 3 | 1 | - |
| no_execution (77) | **20** | 26 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **370** 건
