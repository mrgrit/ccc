...
| no_execution | 77 | 18 | -59 |

**전체 케이스** 3091 · **전체 pass율** 71.8%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **328** | 675 | 25 | 15 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **34** | 31 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **415** 건
...
| agent-ir-adv-nonai | 1 | 0 | 1 | 0 | 0 | 0% |
...
| physical-pentest-ai | 143 | 102 | 14 | 0 | 1 | 71% |
