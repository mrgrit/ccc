...
**전체 케이스** 3090 · **전체 pass율** 71.6%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **323** | 671 | 25 | 14 | - |
| qa_fallback (42) | **22** | 15 | 3 | 1 | - |
| no_execution (77) | **32** | 31 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **407** 건
...
| physical-pentest-ai | 143 | 94 | 11 | 0 | 0 | 66% |
