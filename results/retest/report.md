...
| no_execution | 77 | 15 | -62 |

**전체 케이스** 3090 · **전체 pass율** 70.0%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **289** | 635 | 25 | 12 | - |
| qa_fallback (42) | **21** | 16 | 3 | 1 | - |
| no_execution (77) | **19** | 24 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **359** 건
