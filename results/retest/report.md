...
| no_execution | 77 | 426 | +349 |

**전체 케이스** 3089 · **전체 pass율** 62.1%
...
| no_execution (77) | **1** | 4 | 0 | 72 | - |
| error (70) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **115** 건
