...
| no_execution | 77 | 249 | +172 |

**전체 케이스** 3089 · **전체 pass율** 62.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **116** | 321 | 20 | 234 | - |
| qa_fallback (42) | **17** | 22 | 0 | 3 | - |
| no_execution (77) | **4** | 9 | 0 | 12 | - |
| error (70) | **3** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **140** 건
...
| attack-adv-ai | 235 | 121 | 20 | 0 | 86 | 51% |
