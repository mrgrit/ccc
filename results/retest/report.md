...
| no_execution | 77 | 217 | +140 |

**전체 케이스** 3089 · **전체 pass율** 63.3%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **123** | 338 | 20 | 210 | - |
| qa_fallback (42) | **17** | 22 | 0 | 3 | - |
| no_execution (77) | **7** | 17 | 0 | 4 | - |
| error (70) | **3** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **150** 건
...
| attack-adv-ai | 235 | 131 | 45 | 0 | 54 | 56% |
