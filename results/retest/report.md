...
| no_execution | 77 | 124 | +47 |

**전체 케이스** 3090 · **전체 pass율** 67.8%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **231** | 503 | 25 | 118 | - |
| qa_fallback (42) | **21** | 15 | 2 | 3 | - |
| no_execution (77) | **10** | 20 | 0 | 3 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **292** 건
