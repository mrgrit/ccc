...
| no_execution | 77 | 53 | -24 |

**전체 케이스** 3090 · **전체 pass율** 68.6%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **255** | 548 | 25 | 49 | - |
| qa_fallback (42) | **21** | 16 | 2 | 2 | - |
| no_execution (77) | **10** | 21 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **316** 건
...
| battle-adv-ai | 140 | 69 | 23 | 3 | 38 | 49% |
