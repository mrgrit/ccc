...
| no_execution | 77 | 37 | -40 |

**전체 케이스** 3096 · **전체 pass율** 78.6%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **506** | 532 | 20 | 32 | - |
| qa_fallback (42) | **26** | 12 | 2 | 2 | - |
| no_execution (77) | **55** | 19 | 0 | 2 | - |
| error (70) | **43** | 26 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **630** 건
...
| attack-adv-ai | 235 | 176 | 46 | 0 | 12 | 75% |
