...
| no_execution | 77 | 32 | -45 |

**전체 케이스** 3090 · **전체 pass율** 68.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **262** | 561 | 25 | 29 | - |
| qa_fallback (42) | **21** | 16 | 2 | 2 | - |
| no_execution (77) | **11** | 21 | 0 | 1 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **324** 건
...
| battle-adv-ai | 140 | 77 | 36 | 3 | 17 | 55% |
