...
**전체 케이스** 3096 · **전체 pass율** 73.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **373** | 642 | 25 | 17 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **40** | 27 | 0 | 1 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **466** 건
...
| attack-adv-ai | 235 | 150 | 78 | 0 | 4 | 64% |
