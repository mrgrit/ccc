...
| pass | 1476 | 1759 | **+283** |
| fail | 1448 | 1132 | -316 |
| qa_fallback | 144 | 110 | -34 |
| no_execution | 21 | 87 | +66 |

**전체 케이스** 3089 · **전체 pass율** 56.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1448) | **256** | 1087 | 80 | 25 | - |
| qa_fallback (175) | **30** | 54 | 44 | 46 | - |
| no_execution (21) | **0** | 0 | 0 | 21 | - |
| error (0) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **286** 건
...
| physical-pentest-ai | 143 | 71 | 62 | 3 | 7 | 50% |
