...
| no_execution | 77 | 371 | +294 |

**전체 케이스** 3089 · **전체 pass율** 62.2%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **98** | 303 | 21 | 350 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **1** | 5 | 0 | 17 | - |
| error (70) | **1** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **116** 건
...
| ai-safety-ai | 133 | 107 | 8 | 0 | 0 | 80% |
| ai-security-ai | 147 | 81 | 37 | 7 | 0 | 55% |
| attack-adv-ai | 235 | 113 | 7 | 0 | 107 | 48% |
| attack-ai | 240 | 106 | 8 | 1 | 110 | 44% |
