...
**전체 케이스** 3096 · **전체 pass율** 78.1%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **489** | 547 | 25 | 31 | - |
| qa_fallback (42) | **25** | 12 | 3 | 1 | - |
| no_execution (77) | **55** | 19 | 0 | 2 | - |
| error (70) | **43** | 26 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **612** 건
...
| autonomous-ai | 119 | 71 | 43 | 4 | 0 | 60% |
