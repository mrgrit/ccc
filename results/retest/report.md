...
| no_execution | 77 | 21 | -56 |

**전체 케이스** 3096 · **전체 pass율** 73.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **385** | 630 | 25 | 18 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **45** | 21 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **483** 건
...
| attack-adv-ai | 235 | 167 | 60 | 0 | 6 | 71% |
