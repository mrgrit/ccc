...
| no_execution | 77 | 286 | +209 |

**전체 케이스** 3089 · **전체 pass율** 62.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **102** | 303 | 20 | 267 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **1** | 6 | 0 | 15 | - |
| error (70) | **3** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **122** 건
