...
| no_execution | 77 | 218 | +141 |

**전체 케이스** 3090 · **전체 pass율** 67.0%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **213** | 442 | 26 | 195 | - |
| qa_fallback (42) | **21** | 15 | 2 | 3 | - |
| no_execution (77) | **10** | 19 | 0 | 3 | - |
| error (70) | **23** | 30 | 0 | 17 | - |

**개선 누적**: fail/qa/noexec → pass = **267** 건
...
| ai-security-ai | 147 | 82 | 11 | 4 | 50 | 56% |
