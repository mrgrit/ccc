...
| no_execution | 77 | 20 | -57 |

**전체 케이스** 3096 · **전체 pass율** 73.6%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **378** | 637 | 25 | 17 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **44** | 22 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **475** 건
...
| attack-adv-ai | 235 | 159 | 68 | 0 | 5 | 68% |
