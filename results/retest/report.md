...
| fail | 1096 | 1087 | -9 |
| qa_fallback | 42 | 0 | -42 |
| no_execution | 77 | 81 | +4 |

**전체 케이스** 3089 · **전체 pass율** 59.0%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **4** | 1065 | 0 | 0 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **0** | 0 | 0 | 77 | - |
| error (70) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **20** 건

## 과목별 현재

| 과목 | 전체 | pass | fail | qa_fb | no_exec | pass율 |
|------|------|------|------|-------|---------|--------|
| agent-ir-adv-ai | 179 | 127 | 20 | 0 | 5 | 71% |
| agent-ir-ai | 176 | 110 | 66 | 0 | 0 | 62% |
| ai-agent-ai | 134 | 77 | 57 | 0 | 0 | 57% |
| ai-safety-adv-ai | 134 | 65 | 40 | 0 | 1 | 49% |
| ai-safety-ai | 133 | 105 | 9 | 0 | 0 | 79% |
| ai-security-ai | 147 | 63 | 62 | 0 | 0 | 43% |
