...
| no_execution | 77 | 263 | +186 |

**전체 케이스** 3089 · **전체 pass율** 64.8%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **149** | 335 | 13 | 235 | - |
| qa_fallback (42) | **17** | 22 | 0 | 3 | - |
| no_execution (77) | **8** | 19 | 0 | 6 | - |
| error (70) | **23** | 28 | 0 | 19 | - |

**개선 누적**: fail/qa/noexec → pass = **197** 건
...
| ai-safety-adv-ai | 134 | 85 | 27 | 0 | 0 | 63% |
