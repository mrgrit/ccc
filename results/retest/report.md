...
| pass | 1804 | 2444 | **+640** |
| fail | 1096 | 585 | -511 |
| qa_fallback | 42 | 22 | -20 |
| no_execution | 77 | 38 | -39 |

**전체 케이스** 3096 · **전체 pass율** 78.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **512** | 526 | 20 | 32 | - |
| qa_fallback (42) | **26** | 12 | 2 | 2 | - |
| no_execution (77) | **58** | 15 | 0 | 3 | - |
| error (70) | **43** | 26 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **639** 건

## 과목별 현재

| 과목 | 전체 | pass | fail | qa_fb | no_exec | pass율 |
|------|------|------|------|-------|---------|--------|
| agent-ir-adv-ai | 180 | 148 | 26 | 2 | 2 | 82% |
| agent-ir-adv-nonai | 2 | 0 | 2 | 0 | 0 | 0% |
| agent-ir-ai | 176 | 134 | 38 | 3 | 0 | 76% |
...
| attack-adv-ai | 235 | 185 | 36 | 0 | 13 | 79% |
| attack-adv-nonai | 1 | 0 | 1 | 0 | 0 | 0% |
| attack-ai | 240 | 187 | 50 | 0 | 3 | 78% |
| autonomous-ai | 119 | 73 | 42 | 4 | 0 | 61% |
| autonomous-systems-ai | 120 | 81 | 34 | 5 | 0 | 68% |
| battle-adv-ai | 140 | 98 | 36 | 4 | 2 | 70% |
| battle-ai | 166 | 122 | 42 | 0 | 2 | 73% |
| cloud-container-ai | 131 | 116 | 15 | 0 | 0 | 89% |
| compliance-ai | 145 | 109 | 32 | 1 | 3 | 75% |
| physical-pentest-ai | 143 | 129 | 11 | 0 | 2 | 90% |
