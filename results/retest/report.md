...
| pass | 1804 | 1858 | **+54** |
| fail | 1096 | 702 | -394 |
| qa_fallback | 42 | 11 | -31 |
| no_execution | 77 | 287 | +210 |

**전체 케이스** 3089 · **전체 pass율** 60.1%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **38** | 680 | 11 | 206 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **0** | 0 | 0 | 77 | - |
| error (70) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **54** 건
...
| autonomous-ai | 119 | 60 | 52 | 3 | 4 | 50% |
