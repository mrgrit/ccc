...
| no_execution | 77 | 34 | -43 |

**전체 케이스** 3096 · **전체 pass율** 76.7%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **455** | 570 | 25 | 30 | - |
| qa_fallback (42) | **24** | 13 | 3 | 1 | - |
| no_execution (77) | **47** | 19 | 0 | 2 | - |
| error (70) | **43** | 26 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **569** 건
...
| battle-adv-ai | 140 | 82 | 45 | 4 | 2 | 59% |
