...
| no_execution | 77 | 36 | -41 |

**전체 케이스** 3096 · **전체 pass율** 78.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **497** | 542 | 19 | 32 | - |
| qa_fallback (42) | **26** | 12 | 3 | 1 | - |
| no_execution (77) | **55** | 19 | 0 | 2 | - |
| error (70) | **43** | 26 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **621** 건

## 과목별 현재

| 과목 | 전체 | pass | fail | qa_fb | no_exec | pass율 |
|------|------|------|------|-------|---------|--------|
| agent-ir-adv-ai | 180 | 148 | 27 | 2 | 1 | 82% |
