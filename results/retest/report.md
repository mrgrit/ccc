...
| pass | 1804 | 1973 | **+169** |
| fail | 1096 | 382 | -714 |
| qa_fallback | 42 | 14 | -28 |
| no_execution | 77 | 254 | +177 |

**전체 케이스** 3089 · **전체 pass율** 63.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **139** | 340 | 14 | 226 | - |
| qa_fallback (42) | **17** | 21 | 0 | 4 | - |
| no_execution (77) | **8** | 19 | 0 | 6 | - |
| error (70) | **5** | 2 | 0 | 18 | - |

**개선 누적**: fail/qa/noexec → pass = **169** 건
...
| ai-security-ai | 147 | 82 | 14 | 1 | 49 | 56% |
