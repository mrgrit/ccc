...
| no_execution | 77 | 30 | -47 |

**전체 케이스** 3096 · **전체 pass율** 75.2%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **420** | 607 | 25 | 27 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **47** | 18 | 0 | 2 | - |
| error (70) | **33** | 37 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **523** 건
...
| ai-security-ai | 147 | 105 | 31 | 3 | 8 | 71% |
