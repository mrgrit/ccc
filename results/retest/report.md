...
| no_execution | 77 | 264 | +187 |

**전체 케이스** 3089 · **전체 pass율** 64.2%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **142** | 332 | 13 | 235 | - |
| qa_fallback (42) | **17** | 21 | 0 | 4 | - |
| no_execution (77) | **8** | 19 | 0 | 6 | - |
| error (70) | **13** | 10 | 0 | 19 | - |

**개선 누적**: fail/qa/noexec → pass = **180** 건
...
| ai-safety-adv-ai | 134 | 68 | 5 | 0 | 1 | 51% |
