...
| pass | 1476 | 1647 | **+171** |
| fail | 1448 | 1293 | -155 |
| qa_fallback | 144 | 76 | -68 |
| no_execution | 21 | 72 | +51 |

**전체 케이스** 3089 · **전체 pass율** 53.3%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1448) | **144** | 1248 | 46 | 10 | - |
| qa_fallback (175) | **30** | 54 | 44 | 46 | - |
| no_execution (21) | **0** | 0 | 0 | 21 | - |
| error (0) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **174** 건
