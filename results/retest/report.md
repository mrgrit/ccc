...
| no_execution | 77 | 179 | +102 |

**전체 케이스** 3090 · **전체 pass율** 67.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **220** | 457 | 28 | 169 | - |
| qa_fallback (42) | **21** | 15 | 2 | 3 | - |
| no_execution (77) | **10** | 19 | 0 | 3 | - |
| error (70) | **27** | 39 | 0 | 4 | - |

**개선 누적**: fail/qa/noexec → pass = **278** 건
...
| ai-security-ai | 147 | 92 | 34 | 6 | 15 | 63% |
| attack-adv-ai | 235 | 142 | 73 | 0 | 15 | 60% |
| attack-ai | 240 | 121 | 19 | 0 | 4 | 50% |
