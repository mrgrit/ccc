...
| no_execution | 77 | 17 | -60 |

**전체 케이스** 3090 · **전체 pass율** 71.2%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **316** | 675 | 25 | 14 | - |
| qa_fallback (42) | **22** | 15 | 3 | 1 | - |
| no_execution (77) | **27** | 30 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **395** 건
...
| physical-pentest-ai | 143 | 82 | 14 | 0 | 0 | 57% |
