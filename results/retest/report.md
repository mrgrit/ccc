...
| no_execution | 77 | 26 | -51 |

**전체 케이스** 3096 · **전체 pass율** 74.0%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **387** | 625 | 25 | 23 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **47** | 19 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **487** 건
...
| attack-adv-ai | 235 | 171 | 53 | 0 | 11 | 73% |
