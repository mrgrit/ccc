...
| no_execution | 77 | 206 | +129 |

**전체 케이스** 3089 · **전체 pass율** 63.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **125** | 347 | 20 | 197 | - |
| qa_fallback (42) | **17** | 22 | 0 | 3 | - |
| no_execution (77) | **8** | 19 | 0 | 6 | - |
| error (70) | **3** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **153** 건
...
| attack-adv-ai | 235 | 134 | 56 | 0 | 43 | 57% |
