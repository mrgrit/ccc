...
| no_execution | 77 | 25 | -52 |

**전체 케이스** 3096 · **전체 pass율** 74.5%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **401** | 630 | 25 | 22 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **47** | 18 | 0 | 2 | - |
| error (70) | **30** | 40 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **501** 건
...
| compliance-ai | 145 | 106 | 38 | 1 | 0 | 73% |
