...
| pass | 1476 | 1665 | **+189** |
| fail | 1448 | 1254 | -194 |
| qa_fallback | 144 | 88 | -56 |
| no_execution | 21 | 81 | +60 |

**전체 케이스** 3089 · **전체 pass율** 53.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1448) | **162** | 1209 | 58 | 19 | - |
| qa_fallback (175) | **30** | 54 | 44 | 46 | - |
| no_execution (21) | **0** | 0 | 0 | 21 | - |
| error (0) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **192** 건
...
| autonomous-ai | 119 | 47 | 63 | 9 | 0 | 39% |
