...
| no_execution | 77 | 228 | +151 |

**전체 케이스** 3089 · **전체 pass율** 63.8%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **139** | 348 | 16 | 216 | - |
| qa_fallback (42) | **17** | 22 | 0 | 3 | - |
| no_execution (77) | **8** | 19 | 0 | 6 | - |
| error (70) | **4** | 0 | 0 | 3 | - |

**개선 누적**: fail/qa/noexec → pass = **168** 건
...
| ai-security-ai | 147 | 81 | 21 | 3 | 23 | 55% |
