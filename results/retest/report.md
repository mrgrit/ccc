...
**전체 케이스** 3096 · **전체 pass율** 75.4%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **423** | 603 | 25 | 28 | - |
| qa_fallback (42) | **23** | 14 | 3 | 1 | - |
| no_execution (77) | **47** | 18 | 0 | 2 | - |
| error (70) | **37** | 32 | 0 | 1 | - |

**개선 누적**: fail/qa/noexec → pass = **530** 건
...
| ai-safety-adv-ai | 134 | 93 | 41 | 0 | 0 | 69% |
