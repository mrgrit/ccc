...
| no_execution | 77 | 290 | +213 |

**전체 케이스** 3089 · **전체 pass율** 60.5%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **49** | 663 | 14 | 209 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **0** | 0 | 0 | 77 | - |
| error (70) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **65** 건
...
| autonomous-systems-ai | 120 | 75 | 41 | 3 | 1 | 62% |
