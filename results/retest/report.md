...
| pass | 1804 | 2081 | **+277** |
| fail | 1096 | 523 | -573 |
| qa_fallback | 42 | 30 | -12 |
| no_execution | 77 | 190 | +113 |

**전체 케이스** 3090 · **전체 pass율** 67.3%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **219** | 453 | 28 | 176 | - |
| qa_fallback (42) | **21** | 15 | 2 | 3 | - |
| no_execution (77) | **10** | 19 | 0 | 3 | - |
| error (70) | **27** | 35 | 0 | 8 | - |

**개선 누적**: fail/qa/noexec → pass = **277** 건
...
| ai-security-ai | 147 | 92 | 27 | 6 | 22 | 63% |
| attack-adv-ai | 235 | 142 | 73 | 0 | 15 | 60% |
| attack-ai | 240 | 120 | 18 | 0 | 8 | 50% |
...
| compliance-ai | 145 | 98 | 46 | 1 | 0 | 68% |
