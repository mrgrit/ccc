...
| no_execution | 77 | 430 | +353 |

**전체 케이스** 3089 · **전체 pass율** 60.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **61** | 505 | 20 | 349 | - |
| qa_fallback (42) | **16** | 22 | 0 | 4 | - |
| no_execution (77) | **0** | 0 | 0 | 77 | - |
| error (70) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **77** 건
...
| cloud-container-ai | 131 | 106 | 24 | 0 | 0 | 81% |
