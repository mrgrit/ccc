...
| pass | 1476 | 1634 | **+158** |
| fail | 1448 | 1318 | -130 |
| qa_fallback | 144 | 69 | -75 |
| no_execution | 21 | 67 | +46 |

**전체 케이스** 3089 · **전체 pass율** 52.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1448) | **131** | 1273 | 39 | 5 | - |
| qa_fallback (175) | **30** | 54 | 44 | 46 | - |
| no_execution (21) | **0** | 0 | 0 | 21 | - |
| error (0) | **0** | 0 | 0 | 0 | - |

**개선 누적**: fail/qa/noexec → pass = **161** 건
...
| attack-adv-ai | 235 | 110 | 103 | 3 | 19 | 47% |
