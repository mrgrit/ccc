...
| no_execution | 77 | 245 | +168 |

**전체 케이스** 3090 · **전체 pass율** 66.9%

## Retest 큐 플립 현황

| 이전 상태 → | pass | fail | qa_fallback | no_execution | 미진행 |
|------|------|------|-------------|--------------|--------|
| fail (1096) | **209** | 425 | 22 | 220 | - |
| qa_fallback (42) | **21** | 15 | 2 | 3 | - |
| no_execution (77) | **10** | 19 | 0 | 3 | - |
| error (70) | **23** | 28 | 0 | 19 | - |

**개선 누적**: fail/qa/noexec → pass = **263** 건
...
| attack-adv-ai | 235 | 139 | 59 | 0 | 32 | 59% |
