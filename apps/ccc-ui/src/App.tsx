...
import BastionActivity from './pages/BastionActivity.tsx'
...
const navItems = [
  ...
  { to: '/bastion-activity', label: 'Bastion Activity', icon: '🤖', adminOnly: true },
    ...
    <div style={{ display: 'flex', height: '100vh', minHeight: 0, overflow: 'hidden' }}>
      ...
      <main style={{
        ...
        <Routes>
          ...
          <Route path="/bastion-activity" element={<BastionActivity />} />
