...
> 마지막 업데이트: 2026-04-20 12:40 (error 재테스트 91%)

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 1260 / 3,090 = 40.8%** (수정 전 997 → +263)
- Fail 932, QA-fallback 724, Error 150, No-exec 23, Untested 1
- Error 재테스트 91% 진행 (188 → 150): outage 당시 기록된 error를 VM 복구 후 재돌림
