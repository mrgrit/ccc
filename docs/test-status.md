...
> 마지막 업데이트: 2026-04-20 02:47 (C19 투입)

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 1104 / 3,090 = 35.7%** (수정 전 997 → +107)
- Fail 827, QA-fallback 626, Error 188, No-exec 23, Untested 322

## C19 agent-ir-ai 초반 결과 (34건)

| verdict | 건수 | 비율 | 기존 평균 대비 |
|---------|------|------|----------------|
| pass | 9 | **26%** | 기존 ~10% |
| fail | 21 | 62% | - |
| qa_fb | 4 | **12%** | 기존 ~60%+ |

버그 없는 generator + bastion_prompt=instruction 기본 규칙 적용으로 **처음부터 구조 건강**. qa_fb 12% 수준은 구조적 개선의 실증.
