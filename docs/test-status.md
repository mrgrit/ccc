...
> 마지막 업데이트: 2026-04-19 11:46

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 997 / 3,090 = 32.3%** (992→+5)
- Fail 587, QA-fallback 955, Error 188, No-exec 7, Untested 356

## 재테스트 루프 중간 결과 (120/1009 = 11.9%)
...
- 실행전환율 41.7% (50/120) · pass 전환율 8.3% (10/120)
- 1009건 완주까지 ~12h 남음 (케이스당 평균 44초)
- **Ollama 0.18.2 유지** → gemma4:31b pull 차단 지속 (모델 비교 실험 대기)
