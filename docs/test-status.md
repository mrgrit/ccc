...
> 마지막 업데이트: 2026-04-20 04:20

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 1144 / 3,090 = 37.0%** (수정 전 997 → +147)
- Fail 857, QA-fallback 648, Error 188, No-exec 23, Untested 230

## C19 agent-ir-ai 누적 결과 (126건, 진행 72%)

| verdict | 건수 | 비율 | 기존 재테스트 대비 |
|---------|------|------|---------------------|
| pass | 49 | **39%** | 8.2% 대비 **4.8배** |
| fail | 51 | 40% | - |
| qa_fb | 26 | 21% | 61% 대비 약 1/3 |
