...
> 마지막 업데이트: 2026-04-20 05:53

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 1183 / 3,090 = 38.3%** (수정 전 997 → +186)
- Fail 879, QA-fallback 680, Error 188, No-exec 23, Untested 137
...
## C20 agent-ir-adv-ai 누적 (43건, 24%)
| verdict | 건수 | 비율 |
|---------|------|------|
| pass | 18 | **42%** |
| fail | 8 | 19% |
| qa_fb | 17 | 40% |
C19(40% pass)와 유사 수준, qa_fb 비중 더 높음 (심화 이론 성격)
