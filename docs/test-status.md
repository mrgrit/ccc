...
> 마지막 업데이트: 2026-04-20 04:51

## 요약

- **전체 3,090 케이스** (2,734 기존 + **356 신규 C19·C20**) · 2,734 테스트 수행 (88.5%)
- **엄격 Pass 1155 / 3,090 = 37.4%** (수정 전 997 → +158)
- Fail 867, QA-fallback 659, Error 188, No-exec 23, Untested 198

## C19 agent-ir-ai 누적 결과 (158건, 진행 90%)

| verdict | 건수 | 비율 | 기존 재테스트 대비 |
|---------|------|------|---------------------|
| pass | 60 | **38%** | 8.2% 대비 **4.6배** |
| fail | 61 | 39% | - |
| qa_fb | 37 | 23% | 61% 대비 약 1/3 |
