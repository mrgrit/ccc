...
> 작성: 2026-04-20 15:18 (error=0 완주) · 최종 갱신: 2026-04-20 20:30 (야간 재테스트 2차 진행)
> 대상: 전체 19개 AI 과목 × 15주 × 평균 11스텝 = **3,090 케이스**

## 1. 핵심 수치

| 지표 | 수정 전 | 1차 완주 | **야간 2차 (진행중)** |
|------|---------|---------|-----------|
| **엄격 Pass** | 997 (32.3%) | 1,284 (41.6%) | **1,290 (41.75%)** |
| Fail | 535 | 1,031 | 1,072 |
| QA-fallback | 876 | 751 | 704 |
| Error | 0 → 188(outage) | 0 | 0 |
| No-execution | 7 | 23 | 23 |
| Untested | 693 | 1 | 1 |

**야간 2차 재테스트** (w21~w24 Bastion 개선 누적 후): 751 qa_fb 재돌림 중 — 84/751 (11%).
