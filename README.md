...
### Bastion-Bench (별도 hold-out, 590 task)
공격·방어·AI 보안·컴플라이언스·IR 10 카테고리. 8 메트릭 (success rate · **reuse rate** · MTTC · hallucination rate · step efficiency · audit completeness · safety violation · self-correction). 향후 공개.
