...
BASTION_URL = os.getenv("BASTION_URL", "http://192.168.0.110:9200")
...
def seed_architecture(top_mid: str):
    ...
    if USE_BASTION_API:
        ...
        for aid, name, content in [
            ...
            ("arch-ollama", "Ollama 192.168.0.109:11434", "gpt-oss:120b judge."),
    ...
    arch_specs = [
        ...
        ("arch-ollama", "Ollama LLM 서버 192.168.0.109:11434", "GPU 1장 — gpt-oss:120b judge / gurubot derestricted attack."),
