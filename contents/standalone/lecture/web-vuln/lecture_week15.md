...
### 대상: JuiceShop (http://juice.6v6.lab)
...
================================================================
프로젝트: 기말 종합 점검
대상: OWASP JuiceShop (http://juice.6v6.lab)
...
curl -s -X POST http://6v6-host:9200/ask \
  -H 'Content-Type: application/json' \
  -d '{
    "message": "http://juice.6v6.lab JuiceShop 전체 대상 종합 웹취약점 점검: (1) 보안 헤더 수집, (2) 로그인 API에 SQLi 시도, (3) /api/Users IDOR, (4) /ftp 경로 순회, (5) JWT 디코드해서 발견사항을 CVSS v3.1 점수와 함께 표로 정리해줘."
  }' \
