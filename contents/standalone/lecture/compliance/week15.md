...
# === Phase 3: 위협 / 취약점 ===
nuclei -u http://10.20.32.80 -severity high,critical -j > $DIR/05-nuclei.json
nikto -h http://10.20.32.80 -o $DIR/06-nikto.txt
...
# === Phase 6: TLS / 암호화 ===
testssl.sh --severity HIGH https://10.20.32.80:443 > $DIR/09-tls.txt 2>&1
