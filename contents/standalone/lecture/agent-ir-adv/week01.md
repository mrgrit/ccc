...
| 컨테이너 | 6v6 IP | 역할 | 접속 |
|---------|--------|------|------|
| bastion | 10.20.30.201 | Blue Agent · 관제 | `ssh 6v6-bastion` (pw: ccc) |
| fw (secu) | 10.20.30.1 | 방화벽/HAProxy/Suricata ext · 네트워크 관찰 | `ssh 6v6-fw` |
| web | 10.20.32.80 | 공격 표적 · CI runner 역할 (Apache + JuiceShop) | `ssh 6v6-web` |
| siem | 10.20.32.100 | Wazuh manager + alerts.json | `ssh 6v6-siem` |
| attacker | 10.20.30.202 | Claude Code 공격 세션 (pen-test 13 종) | `ssh 6v6-attacker` |
