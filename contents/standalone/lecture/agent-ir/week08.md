...
```
T+00:00  [Claude Code] 이 대상 http://10.20.40.81:3000/ (6v6-juiceshop) 에 접근하겠습니다.
...
**access.log (발췌)**
```
10.20.30.202 - - [T+00:05] "GET /score-board HTTP/1.1" 200 13421
10.20.30.202 - - [T+00:08] "POST /rest/user/login ..." 403 215
10.20.30.202 - - [T+00:10] "POST /rest/user/login ..." 403 215
...
10.20.30.202 - - [T+00:28] "GET /api/users?token=..." 200 88214
```
