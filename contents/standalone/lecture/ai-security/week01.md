...
>
> **검증 완료:** Ollama(192.168.0.109:11434)에 22개 모델 확인, gemma3:12b 응답 약 5초
...
curl -s http://192.168.0.109:11434/api/tags | python3 -m json.tool
# 또는
curl -s http://192.168.0.109:11434/api/tags | jq '.models[].name'
```
...
curl -X POST http://192.168.0.109:11434/api/generate \
...
curl -X POST http://192.168.0.109:11434/api/chat \
  -H "Content-Type: application/json" \
  -d '{
    "model": "gemma3:12b",
    "messages": [
...
curl -X POST http://192.168.0.109:11434/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{
    "model": "gemma3:12b",
    "messages": [
...
curl -s -X POST http://192.168.0.109:11434/v1/chat/completions \
  -H "Content-Type: application/json" \
  -d '{
    "model": "gemma3:12b",
