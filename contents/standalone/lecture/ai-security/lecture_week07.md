...
#    (Bastion API host = 6v6-host:9200 / 컨테이너 6v6-bastion = 10.20.30.201 에서 /chat, /health, /kg/*, /evidence 로 대기)
...
curl -s "http://6v6-host:9200/evidence?limit=5" | python3 -m json.tool
```
...
curl -s "http://6v6-host:9200/evidence?asset=secu&limit=3" | python3 -m json.tool
```
...
# Bastion(Manager) — host 6v6-host:9200 (또는 컨테이너 6v6-bastion:9200)
