...
```bash
curl -s http://6v6-host:9200/skills | python3 -m json.tool | head -40
```
...
```bash
curl -s http://6v6-host:9200/playbooks | python3 -m json.tool | head -40
```
...
curl -s http://6v6-host:9200/skills    | python3 -m json.tool | head -20
curl -s http://6v6-host:9200/playbooks | python3 -m json.tool | head -20
curl -s http://6v6-host:9200/assets    | python3 -m json.tool
