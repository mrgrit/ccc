...
| web | 10.20.32.80 (dmz) + 10.20.40.80 (int) | 안티포렌식 실습 대상 (dual NIC = vhost 라우팅) | `ssh 6v6-web` (ProxyJump fw) |
| siem | 10.20.32.100 (dmz) | Wazuh manager (로그 무결성 검증, alerts.json + active-response) | `ssh 6v6-siem` (ProxyJump fw) |
