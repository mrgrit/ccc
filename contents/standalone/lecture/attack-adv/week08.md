...
| 컨테이너 | 6v6 IP | 역할 | 접속 |
|---------|--------|------|------|
| bastion | 10.20.30.201 | Control Plane (초기 접근점) | `ssh 6v6-bastion` (pw: ccc) |
| fw | 10.20.30.1 (ext) + 10.20.31.1 (pipe) | 방화벽/HAProxy/Suricata ext (피봇 대상) (nftables + HAProxy host-header) | `ssh 6v6-fw` (ProxyJump bastion) |
| web | 10.20.32.80 | 1차 침투 대상 (Apache + ModSecurity) | `ssh 6v6-web` |
