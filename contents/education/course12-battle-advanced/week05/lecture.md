...
| 호스트 | IP | 역할 | 접속 |
|--------|-----|------|------|
| bastion | 10.20.30.201 | 유출 수신 서버 (C2/Exfil Receiver) | `ssh bastion@10.20.30.201` |
...
scp -o StrictHostKeyChecking=no bastion@10.20.30.201:/tmp/cover.jpg /tmp/upload_image.jpg 2>/dev/null
