...
| secu | 10.20.30.1 | 네트워크 모니터링/DLP/nftables 방화벽 | `sshpass -p1 ssh ccc@10.20.30.1` |
| web | 10.20.30.80 | 감염 호스트 (유출 출발지, 공격자 거점) | `sshpass -p1 ssh ccc@10.20.30.80` |
| siem | 10.20.30.100 | Wazuh SIEM 탐지 및 경보 수집 | `sshpass -p1 ssh ccc@10.20.30.100` |
