...
**Q1.** N-day "4시간 룰"의 의미는?
- (a) 개발자 근무시간
- (b) **공개 → 첫 침해까지 약 4시간**
- (c) 패치 주기
- (d) 보고서 작성 시간

**Q2.** Virtual Patch의 핵심 가치는?
- (a) 영구 해결
- (b) **실제 패치 전 WAF·RASP로 *임시 완화*를 수 분 내 배포**
- (c) 비용
- (d) UI

**Q3.** SBOM이 N-day 대응에 기여하는 이유는?
- (a) 법적 요건
- (b) **어디에 해당 의존성이 있는지 *즉시* 매칭 가능**
- (c) 속도
- (d) 라이선스

**Q4.** 공격자 에이전트가 *변형 페이로드*를 계속 만드는 이유는?
- (a) 재미
- (b) **WAF가 차단한 변형 피드백으로 다음 변형 생성**
- (c) 저장
- (d) 법적

**Q5.** Emergency Patch 결정에서 *가장 먼저* 확인할 조건은?
- (a) 비용
- (b) **자산 노출 여부**
- (c) 승인자
- (d) SLA

**Q6.** CISA KEV 카탈로그가 유용한 이유는?
- (a) 무료
- (b) **실제 악용이 확인된 CVE만 포함 — 우선순위 결정에 강력**
- (c) UI
- (d) API

**Q7.** Bastion의 `ingest_cve_feed` 스킬이 자동으로 해야 할 것은?
- (a) 패치 배포
- (b) **피드 수신 → SBOM 매칭 → Playbook 트리거**
- (c) 네트워크 스캔
- (d) 로그 삭제

**Q8.** Shadow IT가 N-day 대응에 주는 리스크는?
- (a) 비용
- (b) **조직이 파악 못 한 자산이 있어 SBOM·패치 누락**
- (c) 속도
- (d) 법적 위험

**Q9.** 업계 ISAC 공유의 이점은?
- (a) 마케팅
- (b) **동일 CVE에 대해 업계 동료의 관찰·완화 사례 공유**
- (c) 비용 절감
- (d) 라이선스

**Q10.** 재발방지의 핵심 SLA는?
- (a) 패치 주기 1년
- (b) **Virtual Patch 2h · Emergency Patch 48h**
- (c) 로그 보관 1년
- (d) 백업 주기
