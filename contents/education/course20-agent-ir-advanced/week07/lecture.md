...
**Q2.** 하이브리드 공격에서 사람이 *분명히 유리한 단계*는?
- (a) 내부 열거
- (b) **피싱 설계·설득·문화 맥락**
- (c) 데이터 유출
- (d) 측면이동

**Q3.** 탐지 관점에서 *가장 큰 기회*의 단계는?
- (a) 피싱 메일 도달
- (b) 직원 클릭
- (c) **웹셸 업로드·실행**
- (d) 외부 유출
...
**Q4.** 체인 단절의 원칙은?
- (a) 모든 단계 동시에
- (b) **가능한 가장 빠른 단계에서 즉시 단절**
- (c) 마지막 단계만
- (d) 법적 절차 후

**Q5.** FIDO2 MFA가 *패스워드 피싱*을 무효화하는 이유는?
- (a) 속도
- (b) **비밀번호 유출되어도 물리 키 없이는 불가능**
- (c) 무료
- (d) UI

**Q6.** BEC 탐지의 핵심은?
- (a) 이메일 길이
- (b) **내부 결제 경로·권한 변경 요청에 대한 *관리자 재확인***
- (c) 스팸 필터
- (d) 대문자 사용

**Q7.** 에이전트가 발판 후 *분 단위* 진행을 가능케 하는 이유는?
- (a) 메모리
- (b) **내부 열거·자격증명 수집·측면이동의 자동 파이프라인**
- (c) 네트워크
- (d) CPU

**Q8.** 직원 공지의 *신중함*이 필요한 이유는?
- (a) 법적
- (b) **공격자가 정보 수집에 이용 가능**
- (c) 비용
- (d) UI

**Q9.** Bastion 자동 대응의 대표 액션은?
- (a) 이메일 전송
- (b) **웹셸 파일 즉시 격리·경로 차단**
- (c) 직원 해고
- (d) 로그 삭제

**Q10.** JIT(Just-in-time) 권한의 장점은?
- (a) 속도
- (b) **특권이 영구 존재하지 않아 유출 시 영향 최소**
- (c) 비용
- (d) 법적 요건

**정답:** Q1:b · Q2:b · Q3:c · Q4:b · Q5:b · Q6:b · Q7:b · Q8:b · Q9:b · Q10:b
