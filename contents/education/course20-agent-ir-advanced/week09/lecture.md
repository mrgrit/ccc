...
**Q1.** Fileless 3유형은?
- (a) SQL·XSS·CSRF
- (b) **Reflective Load·LOLBin·인터프리터**
- (c) 물리·네트워크·소프트웨어
- (d) 상·중·하

**Q2.** AV가 fileless에 무력한 이유는?
- (a) 가격
- (b) **디스크 파일 기반 해시 매칭이므로 메모리만 실행에 없음**
- (c) 속도
- (d) 라이선스

**Q3.** LOLBin의 예는?
- (a) sqlmap
- (b) **certutil·rundll32·mshta**
- (c) nikto
- (d) hashcat

**Q4.** Sysmon의 역할은?
- (a) 방화벽
- (b) **Windows 시스템 이벤트 상세 로깅 (프로세스·네트워크·레지스트리)**
- (c) 백업
- (d) 탐지 룰 실행

**Q5.** AppLocker·WDAC 의 목적은?
- (a) 로깅
- (b) **실행 파일을 *사전 허용 목록*으로 제한**
- (c) 성능
- (d) UI

**Q6.** PowerShell Script Block Logging의 가치는?
- (a) 속도
- (b) **실행 *직전*의 스크립트를 그대로 로그 — fileless 증거 확보**
- (c) 비용
- (d) 호환성

**Q7.** Linux fileless 분석 도구는?
- (a) netstat
- (b) **LiME + Volatility 3**
- (c) top
- (d) htop

**Q8.** 리버스 셸의 *인터프리터 기반* 특징은?
- (a) 파일 생성
- (b) **socket + pty.spawn 조합으로 셸 인터랙티브 제공**
- (c) GUI 제공
- (d) 암호화 필수

**Q9.** Agent 자동 대응의 *불가피한 한계*는?
- (a) 속도
- (b) **소멸된 프로세스는 복원 불가 — 불확실성 명시 필요**
- (c) 비용
- (d) UI

**Q10.** 재발방지 1순위 축은?
- (a) 백업
- (b) **실행 제한 (AppLocker·WDAC·SELinux)**
- (c) 비용 절감
- (d) UI
