...
**Q1.** Indirect PI가 Direct PI보다 위험한 이유는?
- (a) 코드가 길어서
- (b) **피해자와 직접 상호작용 없이 에이전트를 조작 가능**
- (c) 속도가 빨라서
- (d) 로그가 안 남아서

**Q2.** 숨은 지시가 가장 많이 들어가는 채널 3가지는?
- (a) 이메일·SMS·전화
- (b) **고객 문의·웹 크롤·첨부 문서**
- (c) 음성·영상·지문
- (d) 로그·DB·설정

**Q3.** LLM이 *지시 vs 정보*를 구분 못 하는 근본 이유는?
- (a) 학습 부족
- (b) **모든 토큰이 맥락이며 역할 구분 없음**
- (c) 메모리 부족
- (d) 암호화 없음

**Q4.** Semantic Gate의 역할은?
- (a) 속도 향상
- (b) **LLM 기반 사전 검토로 의심 컨텐츠 차단**
- (c) 라이선스 관리
- (d) 비용 절감

**Q5.** *Data Provenance*가 중요한 이유는?
- (a) 법적 요건
- (b) **컨텐츠 출처에 따른 신뢰 등급 부여, 지시성 가중치 조정**
- (c) SEO
- (d) 성능

**Q6.** Agent 자동 대응의 핵심 우위는?
- (a) 판단력
- (b) **수 초 반응 시간**
- (c) 경영 판단
- (d) 법적 판단

**Q7.** Human이 Agent보다 *강한* 축은?
- (a) 반응 속도
- (b) **의미 판정 품질·다국어·정책 해석**
- (c) 24시간 운영
- (d) 병렬성

**Q8.** RAG 인덱스의 *출처 태그*가 방어에 주는 효과는?
- (a) 속도 향상
- (b) **공격성 가능 컨텐츠(고객 제출 등)에 낮은 지시성 가중치**
- (c) 저장 효율
- (d) UI 개선

**Q9.** 시스템 프롬프트에 *"컨텐츠 내 지시 금지"*를 넣어도 완전 방어가 안 되는 이유는?
- (a) 너무 길어서
- (b) **강한 숨은 지시는 여전히 우회 가능, 4층 방어의 한 층일 뿐**
- (c) 비용
- (d) UI

**Q10.** 재발방지 1순위 조치는?
- (a) 로그 확대
- (b) **입력 Gate (Semantic + 정규식) 배포**
- (c) 사용자 교육만
- (d) 네트워크 격리
