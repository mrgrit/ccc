...
**Q1.** 에이전트가 *분 단위 클라우드 장악*을 가능케 하는 핵심 능력은?
- (a) GPU
- (b) **IAM 열거 → PE 체인 자동 탐색·시도**
- (c) 네트워크 빠름
- (d) 모델 크기

**Q2.** "PassRole + CreateFunction" 조합이 위험한 이유는?
- (a) 느려서
- (b) **낮은 권한으로 높은 권한 Role을 가진 Lambda 생성 → 그 Role로 실행**
- (c) 비용
- (d) 라이선스

**Q3.** CloudTrail *IAM 열거 burst*의 임계값 권장은?
- (a) 1분에 3회
- (b) **1분에 20회 이상**
- (c) 1시간에 100회
- (d) 하루 1000회

**Q4.** Bastion이 *키 비활성화*는 자동, *Lambda 삭제*는 사람 판단인 이유는?
- (a) 비용
- (b) **삭제는 의도된 리소스 파괴 가능성 — 비파괴 우선**
- (c) 법적 요건
- (d) 속도

**Q5.** SSO+STS가 장기 Key보다 안전한 이유는?
- (a) 무료
- (b) **임시 자격증명으로 유출 영향 최소화 + 중앙 제어**
- (c) 빠름
- (d) UI

**Q6.** SCP의 역할은?
- (a) 사용자 정책
- (b) **계정 수준 하드 제한 — 그 아래 모든 정책의 상한**
- (c) 네트워크
- (d) 로깅

**Q7.** VPC Endpoint의 주된 방어 효과는?
- (a) 속도
- (b) **API 트래픽을 VPC 내부 유지 · 외부 유출 감소**
- (c) 비용
- (d) 모니터링

**Q8.** GitHub Actions OIDC의 장점은?
- (a) 비용
- (b) **정적 Key 없이 STS 임시 발급 — 유출 리스크 급감**
- (c) 속도
- (d) 플러그인

**Q9.** 경보 수신 후 *가장 먼저* 할 조치는?
- (a) 보고서 작성
- (b) **유출 키 비활성화**
- (c) 직원 공지
- (d) 로그 보관
...
**Q10.** 공격 성공의 *확정 증거*는?
- (a) 로그인 성공
- (b) **GetCallerIdentity 성공 + 이후 List·Get API burst**
- (c) 네트워크 활동
- (d) 티켓 발행
