...
**Q1.** Kerberoasting이 *오프라인 크랙*을 가능하게 하는 구조적 원인은?
- (a) DC가 약해서
- (b) **TGS-REP가 서비스 계정의 해시로 암호화되어 요청자가 소지**
- (c) 네트워크 지연
- (d) 사용자 암호

**Q2.** RC4-HMAC TGS 요청이 *의심*인 이유는?
- (a) 표준이라서
- (b) **AES가 기본인 현대 AD에서 RC4 요청은 하향 공격 시도**
- (c) 속도 문제
- (d) 라이선스

**Q3.** 에이전트가 Kerberoasting을 *분 단위*로 완성하는 핵심 이유는?
- (a) GPU
- (b) **SharpHound→BloodHound→Rubeus→Hashcat 파이프라인 자동 실행**
- (c) 네트워크
- (d) 암호 약함

**Q4.** 본 사고의 Bastion 대응이 *100% 자동*이 아닌 이유는?
- (a) 기술 부족
- (b) **AD 가용성 리스크 — 잘못된 잠금은 전사 영향**
- (c) 비용
- (d) 법적 요건

**Q5.** 재발방지 최우선 조치는?
- (a) 탐지 룰만
- (b) **서비스 계정 25자+ AES + gMSA**
- (c) 로그 증설
- (d) 사용자 교육

**Q6.** gMSA의 핵심 가치는?
- (a) 속도
- (b) **관리자도 암호를 모르는 상태 · 자동 회전**
- (c) 호환성
- (d) 비용

**Q7.** Tier 0/1/2 모델의 핵심은?
- (a) 성능
- (b) **특권 자격이 하위 Tier에 노출되지 않음**
- (c) 라이선스 분류
- (d) UI

**Q8.** DCSync 이후 탐지되면 *가장 시급*한 조치는?
- (a) 로그 확인
- (b) **krbtgt 2회 회전 준비 + CISO 보고**
- (c) 인력 증원
- (d) 보고서 작성

**Q9.** BloodHound 수집을 탐지하는 주요 관측 소스는?
- (a) 파일 시스템
- (b) **LDAP 쿼리 패턴 (대량·비정형)**
- (c) 웹 로그
- (d) 이메일

**Q10.** *분 단위* Kerberoasting에 대항하는 방어의 가장 큰 가치는?
- (a) 크랙 방어
- (b) **서비스 계정 암호 자체의 크랙 불가능화 (25자+ 무작위)**
- (c) 속도
- (d) 로깅
