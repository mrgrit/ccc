...
flowchart LR
    GPU["NVIDIA GPU"]
    Oll["Ollama 서버<br/>포트 :11434"]
    M1["gemma3:12b<br/><i>주로 사용</i>"]
    M2["llama3.1:8b"]
    M3["기타 모델"]
    API["CCC API<br/>http://localhost:8003"]
    GPU --> Oll
    Oll --> M1
    Oll --> M2
    Oll --> M3
    ...
    style API fill:#21262d,stroke:#f97316,color:#e6edf3
```
...
>
> **검증 완료:** Ollama(localhost:8003)에 22개 모델 확인, gemma3:12b 응답 약 5초
