...
**Q6.** CSA *Mythos-ready CISO Playbook*의 "3-horizon" 중 **이번 주** 조치에 해당하지 *않는* 것은?
- (a) 자산 가시성 점검
- (b) 핵심 시스템 egress 제한
- (c) **VulnOps 전담 팀 채용 공고**
- (d) 에이전트 호출 로깅

**Q7.** Bastion의 3층 성장 구조에서 **반복 패턴**이 누적되어 자동화되는 *경로*는?
- (a) Playbook → Skill
- (b) Skill → Experience
- (c) **Experience → Playbook**
- (d) Playbook → Experience

**Q8.** "에이전트 공격이 아직 약한" 영역에 해당하는 것은?
- (a) 자동 정찰
- (b) 익스플로잇 자동 생성
- (c) **장기 잠복(6개월 이상) + 물리 공격**
- (d) 실패 자가 교정

**Q9.** 좋은 Purple 허점 지적의 네 조건에 해당하지 *않는* 것은?
- (a) 재현 가능
- (b) 수정 가능 제안
- (c) 오탐 고려
- (d) **공격자 비난 강도**

**Q10.** L3→L4 전환의 핵심 도약은?
- (a) 로깅 도입
- (b) 자동 차단 배포
- (c) **Experience → Playbook 자동 승격 시스템 구축**
- (d) 조직 거버넌스 변경

**정답:** Q1:c · Q2:b · Q3:b · Q4:b · Q5:d · Q6:c · Q7:c · Q8:c · Q9:d · Q10:c
