...
# 3. 로그 보관 기간
sshpass -p1 ssh bastion@10.20.30.201 "cat /etc/logrotate.conf | grep -E 'rotate|weekly'"  # 비밀번호 자동입력 SSH
```
...
# 파일 권한
sshpass -p1 ssh bastion@10.20.30.201 "stat -c '%a %n' /etc/shadow /etc/ssh/ssh_host_*_key 2>/dev/null"
```
