...
├──────────┼──────────┼───────────────┤
│공격 시도 │공격 패턴 │자동 차단 규칙 │
│조기 발견 │TTP 분석  │위협 인텔리전스│
│새 봇넷   │악성코드  │방어 전략 수립 │
│IoT 위협  │수집/분석 │시그니처 생성  │
└──────────┴──────────┴───────────────┘
```
...
1. 저상호작용 허니팟과 고상호작용 허니팟의 차이는?
2. Cowrie 허니팟이 시뮬레이션하는 프로토콜은?
3. IoT 허니팟으로 탐지할 수 있는 대표적인 봇넷은?
4. MQTT 허니팟을 운영할 때 주의할 점은?
5. 허니팟 로그를 SIEM에 연동하는 이유는?

### 퀴즈 정답

1. 저상호작용: 서비스 시뮬레이션만(안전, 데이터 제한), 고상호작용: 실제 시스템(위험, 풍부한 데이터)
2. SSH(22), Telnet(23)
3. Mirai, Hajime, IoT Reaper
4. 실제 디바이스와 혼동되지 않도록 격리, 허니팟 자체가 공격 경유지가 되지 않도록 제한
5. 중앙 집중 모니터링, 상관 분석, 자동 대응 규칙 적용
