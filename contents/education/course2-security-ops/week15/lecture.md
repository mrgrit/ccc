...
| 서버 | IP | 접속 |
|------|-----|------|
| secu | 10.20.30.1 | `sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.1` |
| web | 10.20.30.80 | `sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.80` |
| siem | 10.20.30.100 | `sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.100` |
...
```bash
# secu 서버 정리
sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.1 << 'CLEANUP'  # 비밀번호 자동입력 SSH
...
# siem 서버 정리
sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.100 << 'CLEANUP2'  # 비밀번호 자동입력 SSH
