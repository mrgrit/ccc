...
# secu: nftables 상태
echo "=== secu: nftables ==="
sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.1 "sudo systemctl is-active nftables" 2>/dev/null  # 비밀번호 자동입력 SSH

# secu: Suricata 상태
echo "=== secu: Suricata ==="
sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.1 "sudo systemctl is-active suricata" 2>/dev/null  # 비밀번호 자동입력 SSH
...
sshpass -p1 ssh -o StrictHostKeyChecking=no ccc@10.20.30.100 "sudo systemctl is-active wazuh-manager" 2>/dev/null  # 비밀번호 자동입력 SSH
