...
ssh ccc@10.20.30.80 << 'REMOTE'  # 비밀번호 자동입력 SSH
# 현재 cron 확인
echo "=== 설치 전 cron ==="
...
# 3. 정리: cron 백도어 제거
ssh ccc@10.20.30.80 << 'CLEANUP'  # 비밀번호 자동입력 SSH
...
```bash
# web 서버에서 포렌식 조사 수행
ssh ccc@10.20.30.80 << 'FORENSIC'  # 비밀번호 자동입력 SSH
echo "=========================================="
echo "  포렌식 타임라인 재구성"
echo "=========================================="
