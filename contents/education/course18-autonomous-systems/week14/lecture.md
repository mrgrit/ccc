...
1. CPS IR에서 물리적 안전 확보가 최우선인 이유는?
2. IT IR과 CPS IR의 격리 방법 차이는?
3. CPS 인시던트에서 HMI 기만 공격의 위험성은?
4. 수동 전환(Manual Override)의 목적과 한계는?
5. CPS 포렌식에서 IT 포렌식과 다른 증거 유형은?
6. ICS 인시던트에서 PLC를 즉시 네트워크에서 분리하면 안 되는 경우는?
7. 드론 인시던트에서 RTL이 실패하는 상황은?
8. CPS IR 팀에 제어공학 전문가가 필요한 이유는?
9. 인시던트 대응 플레이북의 핵심 구성 요소 5가지는?
10. 사후 분석(Post-Incident)에서 반드시 포함해야 할 내용은?
