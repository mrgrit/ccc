...
1. ROS2에서 토픽과 서비스의 차이점은?
2. DDS가 ROS2에서 사용되는 이유는?
3. UART 디버그 포트의 보안 위험은?
4. ROS2 토픽 스니핑이 가능한 이유는?
5. 펌웨어에서 하드코딩된 자격 증명의 위험은?
6. SPI와 I2C의 차이점은?
7. 로봇 펌웨어 분석에서 strings 추출의 목적은?
8. ROS2 DDS Security 플러그인의 역할은?
9. Secure Boot가 로봇 보안에 중요한 이유는?
10. 로봇 시스템에서 공격 표면을 3개 이상 나열하시오
