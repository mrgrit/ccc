...
1. DDS SPDP Discovery에서 사용하는 멀티캐스트 주소와 포트는?
2. ROS2에서 /cmd_vel 토픽의 역할은?
3. DDS Security의 3가지 핵심 플러그인은?
4. 토픽 인젝션 공격이 가능한 근본 원인은?
5. ROS2 거버넌스(Governance) 파일의 역할은?
6. ROS2 퍼미션(Permissions) 파일에 정의하는 내용은?
7. DDS Data Protection에서 ENCRYPT와 SIGN의 차이는?
8. 로봇 /emergency_stop 토픽에 대한 보안이 중요한 이유는?
9. 멀티캐스트 기반 Discovery의 보안 대안은?
10. ROS2 보안을 적용하지 않은 로봇의 위험 3가지를 쓰시오
