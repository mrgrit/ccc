...
1. CAN 버스에서 우선순위를 결정하는 필드는?
2. CAN FD와 CAN 2.0의 차이점은?
3. Central Gateway ECU의 역할은?
4. V2V 통신에서 Sybil 공격이란?
5. Jeep Cherokee 해킹에서 초기 진입 벡터는?
6. OBD-II 포트의 보안 위험은?
7. CAN 메시지 인젝션의 전제 조건은?
8. V2X 메시지 서명에 사용되는 인증서 체계는?
9. TPMS(타이어 압력 센서)의 보안 위험은?
10. 차량 도메인 분리(Domain Separation)의 목적은?
