...
1. White-box와 Black-box 공격의 차이는?
2. FGSM에서 epsilon의 역할과 영향은?
3. PGD가 FGSM보다 강력한 이유는?
4. 적대적 훈련의 원리를 수식 없이 설명하시오
5. Feature Squeezing 방어의 원리는?
6. 앙상블 방어가 효과적인 이유는?
7. Transferability(전이성)가 공격에 중요한 이유는?
8. CPS에서 AI 적대적 공격이 특히 위험한 이유는?
9. 인증 방어(Certified Defense)의 의미는?
10. AI 모델 페일세이프의 구현 방법 2가지를 쓰시오
