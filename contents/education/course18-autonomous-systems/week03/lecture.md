...
1. WiFi deauthentication 공격이 가능한 이유는?
2. 802.11w (PMF)가 deauth 공격을 어떻게 완화하는가?
3. 드론 하이재킹의 5단계를 순서대로 나열하시오
4. MAVLink 리플레이 공격의 전제 조건은?
5. 드론 명령어 인젝션이 가능한 근본 원인은?
6. SkyJack 공격에 사용된 기술 3가지를 쓰시오
7. 드론 통신 스니핑에서 가장 위험한 발견은?
8. MAVLink v2 서명 기능의 목적은?
9. 물리적 드론 해킹과 가상 시뮬레이션의 차이점은?
10. 드론 해킹의 법적 제약을 2가지 이상 쓰시오
