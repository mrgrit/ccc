...
1. RF 탐지에서 드론이 주로 사용하는 주파수 대역 2가지는?
2. 지오펜싱의 동작 원리를 3단계로 설명하시오
3. 지오펜싱을 우회하는 방법 3가지를 쓰시오
4. 드론 탐지에서 센서 퓨전의 장점은?
5. 안티드론 소프트킬과 하드킬의 차이는?
6. Remote ID 시스템의 목적은?
7. Ray Casting 알고리즘의 용도는?
8. 드론 IDS에서 탐지해야 할 이상 징후 3가지는?
9. RF 핑거프린팅으로 드론 종류를 식별하는 원리는?
10. 마이크로 도플러 분석이 드론 탐지에 유용한 이유는?
