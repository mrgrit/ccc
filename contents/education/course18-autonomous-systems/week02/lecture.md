...
1. 드론의 비행 컨트롤러(FC)의 역할은?
2. MAVLink v1과 v2의 보안 차이점은?
3. 드론 WiFi 통제에서 사용되는 일반적 UDP 포트는?
4. IMU 센서의 구성 요소 2가지를 쓰시오
5. MAVLink HEARTBEAT 메시지의 용도는?
6. WiFi 기반 드론 제어의 보안 취약점 3가지를 나열하시오
7. 드론 텔레메트리 데이터에 포함되는 정보는?
8. ArduPilot과 PX4의 공통점은?
9. MAVLink 패킷에서 System ID의 역할은?
10. 가상 드론 시뮬레이터를 사용하는 이유는?
