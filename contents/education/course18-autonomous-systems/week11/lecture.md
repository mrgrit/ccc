...
1. Purdue 모델에서 PLC가 위치하는 레벨은?
2. Modbus TCP의 기본 포트 번호는?
3. Modbus의 보안 취약점 4가지를 나열하시오
4. Function Code 0x06의 역할은?
5. Stuxnet이 HMI를 기만한 방법은?
6. OT와 IT 보안에서 우선순위 차이는?
7. ICS에서 패치 적용이 어려운 이유 2가지는?
8. SCADA와 DCS의 차이점은?
9. ICS 네트워크 분리(세그멘테이션)의 목적은?
10. Modbus에 대한 IDS 규칙 3가지를 쓰시오
