...
1. GPS 측위에 최소 몇 개의 위성이 필요한가? 이유는?
2. GPS L1 C/A 코드가 스푸핑에 취약한 이유는?
3. GPS 재밍과 스푸핑 중 더 위험한 것은? 이유를 쓰시오
4. 정밀 스푸핑(Sophisticated Spoofing)이 탐지하기 어려운 이유는?
5. GPS 스푸핑 탐지에 SNR 분석이 유용한 이유는?
6. INS(관성항법)의 장점과 단점을 각각 쓰시오
7. 센서 퓨전에서 칼만 필터의 역할은?
8. RQ-170 드론 GPS 스푸핑 사건의 교훈은?
9. Meaconing 공격의 원리를 설명하시오
10. GPS 스푸핑 방어를 위한 기술 3가지를 쓰시오
